...
# 繪製Actual_Value線
plt.plot(new_df['Actual_Value'],new_df['Datetime'], label='Actual_Value')
# 繪製Theoretical_Value線
plt.plot(new_df['Theoretical_Value'],new_df['Datetime'], label='Theoretical_Value')
# 添加圖例
plt.legend()
# 添加標題和軸標籤 
plt.title('SPY231117C00455000')
plt.xlabel('Value')
plt.ylabel('Datetime')
# 顯示圖形
plt.show()
